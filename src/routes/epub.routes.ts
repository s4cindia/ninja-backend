...
router.get('/job/:jobId/asset/*', authenticateFlexible, authorizeJob, epubController.getAsset);
router.get('/job/:jobId/image/*', authenticateFlexible, authorizeJob, epubController.getImage);
