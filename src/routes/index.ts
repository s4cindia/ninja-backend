...
import feedbackAttachmentRoutes from "./feedback-attachment.routes";
import configRoutes from "./config.routes";
import tenantConfigRoutes from "./tenant-config.routes";
import prhRemediationRoutes from "./prh-remediation.routes";
...
import pdfAutoModeRoutes from "./pdf-auto-mode.routes";
...
import annotationReportRoutes from "./annotation-report.routes";
...
router.use("/feedback", feedbackAttachmentRoutes);
router.use("/config", configRoutes);
router.use("/tenant/config", tenantConfigRoutes);
router.use("/jobs", prhRemediationRoutes);
router.use("/jobs", issuesRoutes);
...
router.use("/pdf", pdfAutoModeRoutes);
...
router.use("/calibration", annotationReportRoutes);
